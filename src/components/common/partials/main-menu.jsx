...
{/* 
               ...
               */}
                ...
                <li className={ path.indexOf( "product/" ) > -1 ? 'active' : '' }>
                    <Link to={ `${process.env.PUBLIC_URL}/product/default/7` } >Product</Link>
            ...
            */}
                ...
                <li className={ path.indexOf( "pages" ) > -1 ? 'active' : '' }>
                    ...
                    <ul>
                    <li className={ path.indexOf( "pages/about" ) > -1 && path.indexOf( "pages/about-2" ) === -1 ? 'active' : '' }><Link to={ `${process.env.PUBLIC_URL}/pages/about` }>About </Link></li>
                        ...
                        <li className={ path.indexOf( "pages/contact" ) > -1 && path.indexOf( "pages/contact-2" ) === -1 ? 'active' : '' }><Link to={ `${process.env.PUBLIC_URL}/pages/contact` }>Contact</Link></li>
