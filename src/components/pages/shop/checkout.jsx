...
function Checkout( props ) {
    ...
    return (
        <>
            <Helmet>
                <title>7thLeo | Checkout</title>
            </Helmet>

            <h1 className="d-none">7thLeo - Checkout</h1>
                                    ...
                                    <aside className="col-lg-3">
                                        <div className="summary">
                                            ...
                                            <Accordion type="checkout">
                                                ...
                                                <Card title='PayPal'>
                                                    Pay with PayPal easily and securely, anytime from nearly anywhere.
                                                </Card>
                                                <Card title='Debit/Credit Cards(Stripe)'>
